...
## Overview
The `Templates` specification defines operational configuration, schema definitions, and platform capabilities for Templates in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Templates`.
...
flowchart TD
    ...
    Gateway --> Registry[Templates Service Engine]
