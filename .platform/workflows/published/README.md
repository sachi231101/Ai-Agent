...
## Overview
The `Published` specification defines operational configuration, schema definitions, and platform capabilities for Published in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Published`.
...
flowchart TD
    ...
    Gateway --> Registry[Published Service Engine]
