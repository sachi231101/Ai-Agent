...
## Overview
The `Archives` specification defines operational configuration, schema definitions, and platform capabilities for Archives in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Archives`.
...
flowchart TD
    ...
    Gateway --> Registry[Archives Service Engine]
