...
## Overview
The `SETTINGS` specification defines operational configuration, schema definitions, and platform capabilities for SETTINGS in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `SETTINGS`.
...
flowchart TD
    ...
    Gateway --> Registry[SETTINGS Service Engine]
