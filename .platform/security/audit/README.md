...
## Overview
The `Audit` specification defines operational configuration, schema definitions, and platform capabilities for Audit in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Audit`.
...
flowchart TD
    ...
    Gateway --> Registry[Audit Service Engine]
