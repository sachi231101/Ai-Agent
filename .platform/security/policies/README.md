...
## Overview
The `Policies` specification defines operational configuration, schema definitions, and platform capabilities for Policies in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Policies`.
...
flowchart TD
    ...
    Gateway --> Registry[Policies Service Engine]
