...
## Overview
The `Triggers` specification defines operational configuration, schema definitions, and platform capabilities for Triggers in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Triggers`.
...
flowchart TD
    ...
    Gateway --> Registry[Triggers Service Engine]
