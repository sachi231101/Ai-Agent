...
## Overview
The `Prompts` specification defines operational configuration, schema definitions, and platform capabilities for Prompts in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Prompts`.
...
flowchart TD
    ...
    Gateway --> Registry[Prompts Service Engine]
