...
## Overview
The `Agents` specification defines operational configuration, schema definitions, and platform capabilities for Agents in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Agents`.
...
flowchart TD
    ...
    Gateway --> Registry[Agents Service Engine]
