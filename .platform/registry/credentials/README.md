...
## Overview
The `Credentials` specification defines operational configuration, schema definitions, and platform capabilities for Credentials in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Credentials`.
...
flowchart TD
    ...
    Gateway --> Registry[Credentials Service Engine]
