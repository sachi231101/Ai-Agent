...
## Overview
The `Actions` specification defines operational configuration, schema definitions, and platform capabilities for Actions in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Actions`.
...
flowchart TD
    ...
    Gateway --> Registry[Actions Service Engine]
