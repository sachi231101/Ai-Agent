...
## Overview
The `Tools` specification defines operational configuration, schema definitions, and platform capabilities for Tools in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Tools`.
...
flowchart TD
    ...
    Gateway --> Registry[Tools Service Engine]
