...
## Overview
The `Workflows` specification defines operational configuration, schema definitions, and platform capabilities for Workflows in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Workflows`.
...
flowchart TD
    ...
    Gateway --> Registry[Workflows Service Engine]
