...
## Overview
The `Models` specification defines operational configuration, schema definitions, and platform capabilities for Models in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Models`.
...
flowchart TD
    ...
    Gateway --> Registry[Models Service Engine]
