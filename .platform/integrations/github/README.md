...
## Overview
The `Github` specification defines operational configuration, schema definitions, and platform capabilities for Github in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Github`.
...
flowchart TD
    ...
    Gateway --> Registry[Github Service Engine]
