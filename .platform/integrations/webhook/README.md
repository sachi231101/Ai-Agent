...
## Overview
The `Webhook` specification defines operational configuration, schema definitions, and platform capabilities for Webhook in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Webhook`.
...
flowchart TD
    ...
    Gateway --> Registry[Webhook Service Engine]
