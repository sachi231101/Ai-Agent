...
## Overview
The `Notion` specification defines operational configuration, schema definitions, and platform capabilities for Notion in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Notion`.
...
flowchart TD
    ...
    Gateway --> Registry[Notion Service Engine]
