...
## Overview
The `Mcp` specification defines operational configuration, schema definitions, and platform capabilities for Mcp in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Mcp`.
...
flowchart TD
    ...
    Gateway --> Registry[Mcp Service Engine]
