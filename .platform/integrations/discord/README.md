...
## Overview
The `Discord` specification defines operational configuration, schema definitions, and platform capabilities for Discord in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Discord`.
...
flowchart TD
    ...
    Gateway --> Registry[Discord Service Engine]
