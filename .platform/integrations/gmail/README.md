...
## Overview
The `Gmail` specification defines operational configuration, schema definitions, and platform capabilities for Gmail in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Gmail`.
...
flowchart TD
    ...
    Gateway --> Registry[Gmail Service Engine]
