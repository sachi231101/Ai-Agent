...
## Overview
The `PLATFORM` specification defines operational configuration, schema definitions, and platform capabilities for PLATFORM in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `PLATFORM`.
...
flowchart TD
    ...
    Gateway --> Registry[PLATFORM Service Engine]
