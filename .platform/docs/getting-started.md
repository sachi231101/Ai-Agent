...
## Overview
The `Getting Started` specification defines operational configuration, schema definitions, and platform capabilities for Getting Started in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Getting Started`.
...
flowchart TD
    ...
    Gateway --> Registry[Getting Started Service Engine]
