...
## Overview
The `Api` specification defines operational configuration, schema definitions, and platform capabilities for Api in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Api`.
...
flowchart TD
    ...
    Gateway --> Registry[Api Service Engine]
