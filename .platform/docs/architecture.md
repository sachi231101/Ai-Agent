...
## Overview
The `Architecture` specification defines operational configuration, schema definitions, and platform capabilities for Architecture in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Architecture`.
...
flowchart TD
    ...
    Gateway --> Registry[Architecture Service Engine]
