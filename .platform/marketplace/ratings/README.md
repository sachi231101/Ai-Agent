...
## Overview
The `Ratings` specification defines operational configuration, schema definitions, and platform capabilities for Ratings in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Ratings`.
...
flowchart TD
    ...
    Gateway --> Registry[Ratings Service Engine]
