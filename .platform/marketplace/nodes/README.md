...
## Overview
The `Nodes` specification defines operational configuration, schema definitions, and platform capabilities for Nodes in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Nodes`.
...
flowchart TD
    ...
    Gateway --> Registry[Nodes Service Engine]
