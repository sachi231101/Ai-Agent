...
## Overview
The `Debugger` specification defines operational configuration, schema definitions, and platform capabilities for Debugger in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Debugger`.
...
flowchart TD
    ...
    Gateway --> Registry[Debugger Service Engine]
