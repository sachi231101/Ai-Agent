...
## Overview
The `System` specification defines operational configuration, schema definitions, and platform capabilities for System in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `System`.
...
flowchart TD
    ...
    Gateway --> Registry[System Service Engine]
