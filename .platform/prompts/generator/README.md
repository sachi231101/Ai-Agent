...
## Overview
The `Generator` specification defines operational configuration, schema definitions, and platform capabilities for Generator in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Generator`.
...
flowchart TD
    ...
    Gateway --> Registry[Generator Service Engine]
