...
## Overview
The `Optimizer` specification defines operational configuration, schema definitions, and platform capabilities for Optimizer in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Optimizer`.
...
flowchart TD
    ...
    Gateway --> Registry[Optimizer Service Engine]
