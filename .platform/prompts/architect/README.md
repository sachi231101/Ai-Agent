...
## Overview
The `Architect` specification defines operational configuration, schema definitions, and platform capabilities for Architect in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Architect`.
...
flowchart TD
    ...
    Gateway --> Registry[Architect Service Engine]
