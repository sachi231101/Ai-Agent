...
## Overview
The `Validator` specification defines operational configuration, schema definitions, and platform capabilities for Validator in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Validator`.
...
flowchart TD
    ...
    Gateway --> Registry[Validator Service Engine]
