...
## Overview
The `Planner` specification defines operational configuration, schema definitions, and platform capabilities for Planner in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Planner`.
...
flowchart TD
    ...
    Gateway --> Registry[Planner Service Engine]
