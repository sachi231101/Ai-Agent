...
## Overview
The `Reviewer` specification defines operational configuration, schema definitions, and platform capabilities for Reviewer in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Reviewer`.
...
flowchart TD
    ...
    Gateway --> Registry[Reviewer Service Engine]
