...
## Overview
The `Shortcuts` specification defines operational configuration, schema definitions, and platform capabilities for Shortcuts in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Shortcuts`.
...
flowchart TD
    ...
    Gateway --> Registry[Shortcuts Service Engine]
