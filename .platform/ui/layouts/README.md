...
## Overview
The `Layouts` specification defines operational configuration, schema definitions, and platform capabilities for Layouts in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Layouts`.
...
flowchart TD
    ...
    Gateway --> Registry[Layouts Service Engine]
