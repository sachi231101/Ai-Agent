...
## Overview
The `Capabilities` specification defines operational configuration, schema definitions, and platform capabilities for Capabilities in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Capabilities`.
...
flowchart TD
    ...
    Gateway --> Registry[Capabilities Service Engine]
