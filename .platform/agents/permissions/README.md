...
## Overview
The `Permissions` specification defines operational configuration, schema definitions, and platform capabilities for Permissions in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Permissions`.
...
flowchart TD
    ...
    Gateway --> Registry[Permissions Service Engine]
