...
## Overview
The `Definitions` specification defines operational configuration, schema definitions, and platform capabilities for Definitions in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Definitions`.
...
flowchart TD
    ...
    Gateway --> Registry[Definitions Service Engine]
