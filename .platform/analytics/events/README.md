...
## Overview
The `Events` specification defines operational configuration, schema definitions, and platform capabilities for Events in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Events`.
...
flowchart TD
    ...
    Gateway --> Registry[Events Service Engine]
