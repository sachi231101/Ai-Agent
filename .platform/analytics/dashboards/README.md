...
## Overview
The `Dashboards` specification defines operational configuration, schema definitions, and platform capabilities for Dashboards in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Dashboards`.
...
flowchart TD
    ...
    Gateway --> Registry[Dashboards Service Engine]
