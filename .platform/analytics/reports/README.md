...
## Overview
The `Reports` specification defines operational configuration, schema definitions, and platform capabilities for Reports in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Reports`.
...
flowchart TD
    ...
    Gateway --> Registry[Reports Service Engine]
