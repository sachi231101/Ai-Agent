...
## Overview
The `Members` specification defines operational configuration, schema definitions, and platform capabilities for Members in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Members`.
...
flowchart TD
    ...
    Gateway --> Registry[Members Service Engine]
