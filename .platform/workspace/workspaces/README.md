...
## Overview
The `Workspaces` specification defines operational configuration, schema definitions, and platform capabilities for Workspaces in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Workspaces`.
...
flowchart TD
    ...
    Gateway --> Registry[Workspaces Service Engine]
