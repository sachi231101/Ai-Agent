...
## Overview
The `Roles` specification defines operational configuration, schema definitions, and platform capabilities for Roles in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Roles`.
...
flowchart TD
    ...
    Gateway --> Registry[Roles Service Engine]
