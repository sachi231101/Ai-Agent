...
## Overview
The `Teams` specification defines operational configuration, schema definitions, and platform capabilities for Teams in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Teams`.
...
flowchart TD
    ...
    Gateway --> Registry[Teams Service Engine]
