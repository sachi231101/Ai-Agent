...
## Overview
The `Environments` specification defines operational configuration, schema definitions, and platform capabilities for Environments in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Environments`.
...
flowchart TD
    ...
    Gateway --> Registry[Environments Service Engine]
