...
## Overview
The `Custom` specification defines operational configuration, schema definitions, and platform capabilities for Custom in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Custom`.
...
flowchart TD
    ...
    Gateway --> Registry[Custom Service Engine]
