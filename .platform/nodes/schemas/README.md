...
## Overview
The `Schemas` specification defines operational configuration, schema definitions, and platform capabilities for Schemas in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Schemas`.
...
flowchart TD
    ...
    Gateway --> Registry[Schemas Service Engine]
