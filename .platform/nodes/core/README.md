...
## Overview
The `Core` specification defines operational configuration, schema definitions, and platform capabilities for Core in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Core`.
...
flowchart TD
    ...
    Gateway --> Registry[Core Service Engine]
