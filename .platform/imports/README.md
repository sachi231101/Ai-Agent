...
## Overview
The `README` specification defines operational configuration, schema definitions, and platform capabilities for README in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `README`.
...
flowchart TD
    ...
    Gateway --> Registry[README Service Engine]
