...
## Overview
The `Routing` specification defines operational configuration, schema definitions, and platform capabilities for Routing in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Routing`.
...
flowchart TD
    ...
    Gateway --> Registry[Routing Service Engine]
