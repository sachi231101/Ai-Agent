...
## Overview
The `Ollama` specification defines operational configuration, schema definitions, and platform capabilities for Ollama in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Ollama`.
...
flowchart TD
    ...
    Gateway --> Registry[Ollama Service Engine]
