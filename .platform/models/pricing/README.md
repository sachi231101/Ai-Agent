...
## Overview
The `Pricing` specification defines operational configuration, schema definitions, and platform capabilities for Pricing in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Pricing`.
...
flowchart TD
    ...
    Gateway --> Registry[Pricing Service Engine]
