...
## Overview
The `Deepseek` specification defines operational configuration, schema definitions, and platform capabilities for Deepseek in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Deepseek`.
...
flowchart TD
    ...
    Gateway --> Registry[Deepseek Service Engine]
