...
## Overview
The `Openai` specification defines operational configuration, schema definitions, and platform capabilities for Openai in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Openai`.
...
flowchart TD
    ...
    Gateway --> Registry[Openai Service Engine]
