...
## Overview
The `Anthropic` specification defines operational configuration, schema definitions, and platform capabilities for Anthropic in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Anthropic`.
...
flowchart TD
    ...
    Gateway --> Registry[Anthropic Service Engine]
