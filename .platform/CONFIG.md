...
## Overview
The `CONFIG` specification defines operational configuration, schema definitions, and platform capabilities for CONFIG in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `CONFIG`.
...
flowchart TD
    ...
    Gateway --> Registry[CONFIG Service Engine]
