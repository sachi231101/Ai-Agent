...
## Overview
The `Imports` specification defines operational configuration, schema definitions, and platform capabilities for Imports in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Imports`.
...
flowchart TD
    ...
    Gateway --> Registry[Imports Service Engine]
