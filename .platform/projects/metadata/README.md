...
## Overview
The `Metadata` specification defines operational configuration, schema definitions, and platform capabilities for Metadata in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `Metadata`.
...
flowchart TD
    ...
    Gateway --> Registry[Metadata Service Engine]
