...
## Overview
The `FEATURES` specification defines operational configuration, schema definitions, and platform capabilities for FEATURES in Vibe Agents.
...
## Responsibilities
- Define system registration, validation schemas, and runtime configurations for `FEATURES`.
...
flowchart TD
    ...
    Gateway --> Registry[FEATURES Service Engine]
